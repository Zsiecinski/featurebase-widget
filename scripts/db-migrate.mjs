...
//
// On Railway: this runs automatically as part of `npm start` (see
// package.json) so a fresh Postgres instance gets schema applied on first
// boot. If DATABASE_URL is unset, the script no-ops and exits 0 so the
// server still boots in db-less mode.
